    ...
    for (var j=-1;j<=1;j++)
    {
        ...
        if gamecell_is_on_grid(checkX,checkY){
            ...
            if !gamecell_is_valid(checkX,checkY){
                ...
                ds_list_add(checkedList,Array(checkX,checkY));
            ...
            ds_list_add(checkList,Array(checkX,checkY));
...
if emptiesOnly and recursions == 0 and ds_list_empty(checkList){
   ...
   ds_list_add(checkList,Array(gX,gY)); //since we normally skip this cell
