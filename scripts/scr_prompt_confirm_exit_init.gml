...
prompt_button[0] = Array(spr_button_basic, "no", 0,power_type_color_index(2,0), power_type_color_index(2,1)); 
prompt_button[1] = Array(spr_button_basic, "yes",1,power_type_color_index(1,0), power_type_color_index(1,1)); 
