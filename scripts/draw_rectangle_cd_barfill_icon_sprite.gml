///draw_rectangle_cd_barfill_icon_sprite(x1, y1, x2, y2, value,count,sprite,color,symcolor)
...
draw_sprite_ext(s_v_icon_background,0,xm,ym,1,1,0,color,1) //60x60 canvas for these
draw_sprite_ext(sprite,0,xm,ym,1,1,0,symcolor,1);

//Draw icon fill only in above region w/ alpha 1 and up to the bar fill
draw_sprite_part_ext(s_v_icon_background,0,0,0,60,(1-v)*60,xm-30,ym-30,1,1,COLORS[7],.45)
