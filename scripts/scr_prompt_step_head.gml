...
if promptTextType == 1 {
    prompt_button[++i] = scr_create_array(spr_button_basic, "play", promptTextType, buttonType.play, 3, power_type_color_index(3,1));
} else if true {
    prompt_button[++i] = scr_create_array(spr_button_basic, "music", promptTextType, buttonType.donate, 3, power_type_color_index(3,1));
}
                           //button sprite //button text  //button cash reward //button id //button color //button text color 
prompt_button[++i] = scr_create_array(spr_button_basic, "message", promptTextType, buttonType.message, 2, power_type_color_index(2,1));
if touchPad != 0 {
    prompt_button[++i] = scr_create_array(spr_button_basic, "rate", promptTextType, buttonType.rate, 1, power_type_color_index(1,1));
}
else {
    prompt_button[++i] = scr_create_array(spr_button_basic, "get app", promptTextType, buttonType.rate,1, power_type_color_index(1,1));
}
