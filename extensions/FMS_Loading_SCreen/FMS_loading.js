...
//////////////////////  Settings for TEXT //////////////////////
		...
		var loading_text_color="rgb(255, 255, 255)";	    //text color in rgb
...
//////////////////////  LOADING BAR SETTINGS ////////////////////////////////	
		var barwidth = (_width/2) ;					//Loading bar width in pixel, use (_width / 100) * 50 to have a bar 50% width of screen
		var barheight = 20;                          	// Loading bar height in pixel
		var x = (_width - barwidth) / 2;				// Loading bar orizizontal position (in example centered orizontally)
		var y = _height * .75 - barheight / 2;		// Loading bar vertical position (in example moved 150px down from center)
		var w = (barwidth / _total) * _current;         //variable to calculate width during loading progress, DON'T EDIT
		var border = 2   								// Bar border width in pixel
		var border_color= "rgb(255,255,255)";  			//Bar border color in rgb
		var bar_bg= "rgb(39,39,39)";   					//Bar Background color 
		var progress_bg= "rgb(255, 255, 255)"; 			//Progress Bar color
///////////////////// BACKGROUND SETTINGS   ///////////////////////////////////
		var window_bgd="rgb(0,0,0)"; 				//Background color 
...
//////////////////// CUSTOM IMAGE SETTINGS TO BE USED INSTEAD OR TOGETHER GM:S LOADING SCREEN, LEAVE URL EMPTY IF NOT NEEDED		
		...
		//customlogo.src = "";                     	//URL to custom image, leave empty if not needed
