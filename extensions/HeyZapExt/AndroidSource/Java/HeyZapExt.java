...
//  ver 0.8
//
//  Released by Vitaliy Sidorov on 10/10/2015..
//  Copyright SilenGames, 2015.
//
...
//import com.heyzap.sdk.ads.HeyzapAds.BannerAdSize;
...
private BannerAdView bannerAdView = null;
	...
	public void HeyZap_Init(String _app_id, double istest) {
		...
		if (istest == 1) {
			...
			Log.i("yoyo","Switching HeyZap Test Mode");
		} else {
			HeyzapAds.start(app_id, RunnerActivity.CurrentActivity);
			Log.i("yoyo","No HeyZap Test Mode");
		}
		Log.i("yoyo","HeyZap Init Success!");
		setupCallbacks();
	}
	...
	public void HeyZap_AddBanner(double _pos) {
		...
		if (BannerVPos == 1) {
			...
			Log.i("yoyo","HeyZap Show Banner TOP!");
		} else {
			BannerAd.display(RunnerActivity.CurrentActivity, Gravity.BOTTOM);
			Log.i("yoyo","HeyZap Show Banner BOTTOM!");
		}
	...
	protected void setupCallbacks() {
        HeyzapAds.OnStatusListener statusListener = new HeyzapAds.OnStatusListener() {
            ...
            public void onFailedToFetch(String tag) {
                Log.i("yoyo","HeyZap Ad Loading Failed!");
				sendCallbacks("heyzap_ad_loaded", 0);
            }

            @Override
            public void onFailedToShow(String tag) {
                Log.i("yoyo","HeyZap Ad Shown Failed!");
            }

            @Override
            public void onAudioStarted() {
                Log.i("yoyo","HeyZap Audio Started!");
            }

            @Override
            public void onAudioFinished() {
                Log.i("yoyo","HeyZap Audio Stopped!");
            }
